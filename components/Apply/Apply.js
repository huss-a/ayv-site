      ...
      <Container className="apply-container my-4">
          ...
          <Card.Body>
            <ListGroup className="list-group">
              {reqs.map((requirement, index) => (
                <ListGroup.Item
                  key={Math.random(Math.floor * index)}
                >
                  {requirement}
                </ListGroup.Item>
              ))}
        ...
        >
          <Card.Header>
            ...
            <Card.Subtitle className="mt-2">
              <h6>
                If you meet all requirements listed above, you may apply through
                this{" "}
                <a
                  className="link"
          ...
          <Card.Body>
            <Card.Text>
              <p>
                ...
                to another form, which will be a Theoretical Test that will test
                your knowledge of Flying in Infinite Flight. <br />
                <br />
                Upon submitting the Theory Test, A Staff Member will contact you
                within 12-24 hours.
                <br />
                <br />
                ...
                <br />
                <br />
                However, if you do not pass the Test, you will have 1 week to do
                a retest.
              </p>
            </Card.Text>
          </Card.Body>
