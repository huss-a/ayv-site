...
const Contact = () => {
  useEffect(() => {
    document.title = "Finnair Virtual | Contact Us";
  });

  return (
    <div className="contact-form-wrapper">
      <Container style={{ height: "100vh" }} className="contact-form-container">
        <Card className="form-card animate__animated animate__fadeInRight">
          <div className="jumbotron mt-4 contact-form-header">
            ...
            <h6>
              ...
              >
                Shoot us a DM <i id="envelope" className="fas fa-envelope" /> on
                the IFC
              </a>{" "}
