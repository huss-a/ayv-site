          ...
          <Container className="apply-container my-4">
            ...
            >
              ...
              <Card.Body>
                <Card.Text>
                  <p>
                    After you have submitted your application, you will see a
                    link to another form, which will be a Theoretical Test that
                    will test your knowledge of Flying in Infinite Flight.{" "}
                    <br />
                    <br />
                    ...
                    <br />
                    <br />
                    However, if you do not pass the Test, you will have 1 week
                    to do a retest.
                  </p>
                </Card.Text>
              </Card.Body>
